...
### 2、说一下减少 dom 数量的办法？一次性给你大量的 dom 怎么优化？
...
### 3、Html5 有哪些新特性？如何处理 Html5 新标签的浏览器兼容问题？如何区分 Html 和 Html5?
...
### 8、script 的 async 跟 defer 的区别？



### 9、知道语义化吗？说说你理解的语义化，如果是你，平时会怎么做来保证语义化？说说你了解的 HTML5 语义化标签？
